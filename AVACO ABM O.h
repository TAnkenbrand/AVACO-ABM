...
//	if (ai2 == 5) ai4 = doptimizer(0, ttt, nn, ai1);
...
{
	agenttemp.agenta[0] = agenttemp.agenta[0] - agenttemp.agento[0] * prices[t + 1][0];
	agenttemp.agenta[1] = agenttemp.agenta[1] + agenttemp.agento[0];
	agenttemp.agento[0] = 0;

	agenttemp.agenta[0] = agenttemp.agenta[0] - agenttemp.agento[1] / prices[t + 1][1];
	agenttemp.agenta[2] = agenttemp.agenta[2] + agenttemp.agento[1];
	agenttemp.agento[1] = 0;

	agenttemp.agenta[0] = agenttemp.agenta[0] - agenttemp.agento[2] * prices[t + 1][2];
	agenttemp.agenta[3] = agenttemp.agenta[3] + agenttemp.agento[3];
	agenttemp.agento[2] = 0;

	agenttemp.agenta[1] = agenttemp.agenta[1] - agenttemp.agento[3] * prices[t + 1][3];
	agenttemp.agenta[4] = agenttemp.agenta[4] + agenttemp.agento[3];
	agenttemp.agento[3] = 0;

	agenttemp.agenta[2] = agenttemp.agenta[2] - agenttemp.agento[4] * prices[t + 1][4];
	agenttemp.agenta[5] = agenttemp.agenta[5] + agenttemp.agento[4];
	agenttemp.agento[4] = 0;

	agenttemp.agenta[0] = agenttemp.agenta[0] - agenttemp.agento[5] * prices[t + 1][5];
	agenttemp.agenta[6] = agenttemp.agenta[6] + agenttemp.agento[5];
	agenttemp.agento[5] = 0;

	agenttemp.agenta[1] = agenttemp.agenta[1] - agenttemp.agento[6] * prices[t + 1][6];
	agenttemp.agenta[7] = agenttemp.agenta[7] + agenttemp.agento[6];
	agenttemp.agento[6] = 0;

	agenttemp.agenta[2] = agenttemp.agenta[2] - agenttemp.agento[7] * prices[t + 1][7];
